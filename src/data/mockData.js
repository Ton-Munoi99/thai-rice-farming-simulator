...
export const WHITE_RICE_SURVIVAL_PRESETS = [
  {
    key: "debtCycle",
    icon: "⚠️",
    name: "Debt-cycle baseline",
    th: "ฐานเสี่ยงขาดทุน",
    pricePerTon: 8000,
    ...
    note: "ถ้าผลผลิตกลาง ๆ ราคา 8,000 และต้นทุนเต็ม มีโอกาสต้องกู้หมุน",
    noteEn: "Mid yield, 8,000 baht/ton and full cost can push farmers into working-capital debt.",
  },
  {
    key: "breakEven",
    icon: "🧮",
    name: "Break-even discipline",
    ...
    inputs: {
      applications: [
        ...
        { stage: "Tillering", formula: "46-0-0", rate: 9 },
        { stage: "Panicle", formula: "0-0-60", rate: 8 },
      ],
      water: "Alternate Wet-Dry (AWD)",
      groundwater: 62,
    ...
    note: "ต้องคุมต้นทุนลงใกล้ 5,400 และลดความเสี่ยงให้ต่ำ",
    noteEn: "Requires cost discipline near 5,400 baht/rai and low field risk.",
  },
  {
    key: "suphanIrrigated",
    icon: "💧",
    name: "Suphan-style irrigated",
    th: "สุพรรณฯ น้ำดี",
    pricePerTon: 9200,
    ...
    note: "รอดจากน้ำแน่นอน scale/เครื่องจักร ต้นทุนต่ำ และไม่รีบขาย",
    noteEn: "Works through reliable irrigation, scale, machinery, low cost and better selling timing.",
  },
  {
    key: "strawAndService",
    icon: "🌾",
    name: "Straw + service income",
    th: "ฟาง+รับจ้างเสริม",
    pricePerTon: 8800,
    ...
    inputs: {
      applications: [
        { stage: "Basal", formula: "16-20-0", rate: 26 },
        { stage: "Tillering", formula: "46-0-0", rate: 9 },
        { stage: "Panicle", formula: "0-0-60", rate: 8 },
      ],
      water: "Alternate Wet-Dry (AWD)",
    ...
    note: "เหมาะกับคนมีเครื่องจักร/ตลาดฟาง ลดเงินสดจ่ายและเพิ่มรายได้เสริม",
    noteEn: "Best for machinery owners or farmers with a straw market; lowers cash cost and adds side revenue.",
  },
];
