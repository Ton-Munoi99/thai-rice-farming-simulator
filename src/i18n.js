...
export const TEXT = {
  ...
  simpleResult: { en: "Simple result", th: "สรุปแบบง่าย" },
  nextActions: { en: "What to do next", th: "ควรทำอะไรต่อ" },
  quickScenarios: { en: "Quick scenarios", th: "สถานการณ์เร็ว" },
  quickScenariosSub: {
    en: "Start here first. Advanced farm systems and survival cases are below.",
    th: "เริ่มจากตรงนี้ก่อน ส่วนระบบนาและทางรอดแบบละเอียดอยู่ด้านล่าง",
  },
