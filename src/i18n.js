...
export const TEXT = {
  ...
  baseSalePrice: { en: "Base sale price", th: "ราคาขายฐาน" },
  adjustedSalePrice: { en: "Adjusted sale price", th: "ราคาขายสุทธิ" },
  priceAdjustment: { en: "Price adjustment", th: "ราคาสะท้อนเงื่อนไข" },
  priceImpact: { en: "Price impact", th: "ผลกระทบราคา" },
  qualityFactor: { en: "Quality factor", th: "ตัวคูณคุณภาพ" },
  bahtPerTon: { en: "฿ / ton (1,000 kg)", th: "บาท / ตัน (1,000 กก.)" },
  strawIncome: { en: "Collectable straw", th: "ฟางเก็บขายได้" },
  strawPrice: { en: "Straw price", th: "ราคาฟาง" },
  bahtPerKg: { en: "฿ / kg", th: "บาท / กก." },
  strawRevenue: { en: "Straw revenue", th: "รายได้ฟาง" },
  riceRevenue: { en: "Rice", th: "ข้าว" },
  strawReference: { en: "Linked to yield and harvest conditions; Thai reference range 400-500 kg/rai collectable straw.", th: "ลิงก์กับผลผลิตและสภาพเก็บเกี่ยว; ค่าอ้างอิงไทย ฟางเก็บได้จริงราว 400-500 กก./ไร่" },
