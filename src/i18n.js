...
export const TEXT = {
  ...
  presetLibrarySub: {
    en: "Choose one starting point, then adjust the manual controls below.",
    th: "เลือกจุดเริ่มต้นหนึ่งแบบ แล้วปรับรายละเอียดเองต่อด้านล่าง",
  },
  ...
  editedManuallyNote: {
    en: "Preset marker cleared because settings were adjusted by hand.",
    th: "ล้างสถานะ preset แล้ว เพราะมีการปรับค่าเอง",
  },
  ...
  whiteRiceSurvivalSub: {
    en: "Apply linked white-rice cases: price, cost, water, straw, and field risk.",
    th: "กดกรณีข้าวขาวที่ผูก ราคา ต้นทุน น้ำ ฟาง และความเสี่ยงแปลง",
  },
  ...
  cashflowDebtSub: {
    en: "If this crop loses money, estimate short-term borrowing and next-crop target.",
    th: "ถ้ารอบนี้ขาดทุน ประเมินเงินกู้หมุนและเป้าหมายรอบหน้า",
  },
  ...
  debtNoteLoss: {
    en: "Assumes a 6-month working-capital loan at 6% annual interest. Adjust later with real loan terms.",
    th: "สมมติเงินกู้หมุน 6 เดือน ดอกเบี้ย 6% ต่อปี ระยะต่อไปควรปรับด้วยเงื่อนไขสินเชื่อจริง",
  },
  debtNoteProfit: {
    en: "This crop is cash-positive; the same panel shows how much cushion is available before the next crop.",
    th: "รอบนี้เงินสดเป็นบวก แผงนี้จึงใช้ดู buffer ก่อนเริ่มรอบถัดไป",
  },
  ...
  moistureNote: {
    en: "Rice price stays market-driven; only wet-harvest moisture can discount revenue.",
    th: "ราคาข้าวเป็นราคาตลาด; ระบบหักรายได้เฉพาะกรณีความชื้นจากเก็บเกี่ยวเปียก",
  },
  ...
  strawReference: {
    en: "Rice-map method: paddy × RPR 1.169 × SAF 0.583, then harvest-condition adjustment.",
    th: "วิธี rice-map: ผลผลิตข้าวเปลือก × RPR 1.169 × SAF 0.583 แล้วปรับด้วยสภาพเก็บเกี่ยว",
  },
  ...
  autoPlanSub: {
    en: "Apply one plan to change linked costs, field conditions, and straw assumptions.",
    th: "กดใช้แผนเพื่อปรับต้นทุน เงื่อนไขแปลง และสมมติฐานฟางที่เชื่อมกัน",
  },
  ...
  decisionStatus: { en: "Decision status", th: "สถานะตัดสินใจ" },
  primaryPressure: { en: "Main pressure", th: "แรงกดดันหลัก" },
  costStructure: { en: "Cost structure", th: "โครงสร้างต้นทุน" },
  reportGo: { en: "Viable", th: "ไปต่อได้" },
  reportWatch: { en: "Watch closely", th: "พอรอดแต่ต้องระวัง" },
  reportStop: { en: "Needs fixing", th: "ต้องแก้ก่อน" },
  reportFooterNote: {
    en: "This report is for planning discussion. Replace defaults with local farm records, buyer prices, loan terms, and agronomic advice before making final decisions.",
    th: "รายงานนี้ใช้เพื่อคุยและวางแผน ควรแทนค่า default ด้วยบัญชีฟาร์ม ราคาผู้รับซื้อ เงื่อนไขเงินกู้ และคำแนะนำวิชาการในพื้นที่ก่อนตัดสินใจจริง",
  },
